## Building Netflix from Scratch Using React (Custom Hooks, Context, Portals), Firebase, Compound & Styled Components (Followed a 10 Hour Tutorial Here: https://www.youtube.com/watch?v=x_EEwGe-a9o)
